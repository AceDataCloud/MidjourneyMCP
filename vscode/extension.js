...
//
// Registers the hosted Ace Data Cloud "midjourney" MCP server with VS Code
...
//   2. VS Code SecretStorage (key "midjourney.apiToken")
...
//   - acedatacloud.midjourney.setApiToken
//   - acedatacloud.midjourney.clearApiToken

const vscode = require("vscode");

const PROVIDER_ID = "acedatacloud.midjourney";
const SERVER_LABEL = "Midjourney MCP";
const SERVER_URL = "https://midjourney.mcp.acedata.cloud/mcp";
const SET_TOKEN_CMD = "acedatacloud.midjourney.setApiToken";
const CLEAR_TOKEN_CMD = "acedatacloud.midjourney.clearApiToken";
// Per-extension SecretStorage namespace; we keep one key per service so
// rotating one API key doesn't affect siblings.
const SECRET_KEY = "midjourney.apiToken";
